...
import { createDriver, updateDriver } from "@/api/superadmin/drivers"
...
import { Driver } from "@/api/superadmin/drivers/driver"

export default function DriverDialog() {
  const { isOpen, setIsOpen } = useDriverDialog(
    useShallow((state) => ({
      isOpen: state.isOpen,
  ...
  defaultValues: {
    usernameOrEmail: driver?.usernameOrEmail ?? "",

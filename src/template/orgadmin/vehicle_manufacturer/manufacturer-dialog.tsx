...
import { createVehicleManufacturer, updateVehicleManufacturer } from "@/api/orgadmin/vehicle_manufacturer"
...
export default function VehicleManufacturerDialog() {
  ...
  const handleSubmit = async (values: z.infer<typeof manufacturerSchema>) => {
    if (vehicle_manufacturer) {
      await updateVehicleManufacturer(vehicle_manufacturer.id, {
        ...values,
